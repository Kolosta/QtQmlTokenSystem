...
/**
 * CustomButton - Wrapper de compatibilité
 * Redirige vers OButton pour compatibilité avec le code existant
 */
OButton {
    // Toutes les propriétés sont héritées de OButton
    // Ce composant existe uniquement pour la compatibilité
}