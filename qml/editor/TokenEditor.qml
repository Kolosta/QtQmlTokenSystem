    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Text {
                ...
                Layout.topMargin: DS.spacing.xl
                Layout.fillWidth: true
            }
            
            Text {
                text: "These tokens are specific to components and can have direct values or reference other tokens."
                font.pixelSize: 13
                color: DS.color.text.secondary
                wrapMode: Text.WordWrap
                Layout.fillWidth: true
