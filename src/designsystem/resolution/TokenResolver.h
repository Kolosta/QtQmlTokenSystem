...
private:
    ...
    // Nouvelle méthode pour déréférencer récursivement (semantic -> semantic -> ... -> primitive)
    QVariant dereferenceRecursive(const QVariant& value, ThemeType theme, int depth);
