...
//     registerAction("edit.redo", "Edit", "Redo", QKeySequence::Redo);
...
//     // View menu
//     registerAction("view.increase_scale", "View", "Increase UI scale", QKeySequence(Qt::CTRL | Qt::Key_Plus));
...
//     qDebug() << "KeymapManager: Initialized" << m_actions.size() << "default shortcuts";
// }

// void KeymapManager::registerAction(const QString& id, const QString& category,
//                                    const QString& description, const QKeySequence& defaultShortcut) {
//     KeymapAction action;
//     action.id = id;
//     action.category = category;
//     action.description = description;
//     action.defaultShortcut = defaultShortcut;
//     action.currentShortcut = defaultShortcut;
...
//     m_actions[actionId].currentShortcut = sequence;
    
//     saveKeymaps();
//     emit shortcutChanged(actionId);
//     emit keymapsChanged();
    
//     qDebug() << "KeymapManager: Updated" << actionId << "to" << shortcut;
//     return true;
// }
...
//         map["defaultShortcut"] = action.defaultShortcut.toString();
//         map["currentShortcut"] = action.currentShortcut.toString();
//         result.append(map);
//     }
//     return result;
// }
...
//     QKeySequence sequence(shortcut);
//     for (const auto& action : m_actions) {
//         if (action.id != excludeActionId && action.currentShortcut == sequence) {
//             return action.id;
//         }
//     }
//     return QString();
...
//     for (auto it = m_actions.begin(); it != m_actions.end(); ++it) {
//         QString saved = m_settings->value(it->id).toString();
//         if (!saved.isEmpty()) {
//             it->currentShortcut = QKeySequence(saved);
//         }
//     }
...
//             m_settings->setValue(action.id, action.currentShortcut.toString());
//         } else {
